...
const useWordle = (solution) => {
  ...
  console.log("useWordle Current Guess:", currentGuess);
  console.log("useWordle Guesses:", guesses);
  console.log("useWordle Turn:", turn);
  console.log("useWordle Is Correct:", isCorrect);
